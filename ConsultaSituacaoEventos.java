 ...
 */
public class ConsultaSituacaoEventos extends AsyncTask<Void, Void, String> {
    ...
    public ConsultaSituacaoEventos(ConsultaSituacaoEventosListener listener){
    ...
    private String interpretaResultado(String resultado) throws JSONException {
        ...
        for( int x = 0; x < jsonArray.length(); x++){
            ...
            idEvento = jsonObjectEvent.getString("_id") + "&";
            ...
            eventos += nomeEvento + idEvento +  imagemEvento + atracaoEvento + dataEvento + horaEvento;
        }
        return eventos;
    }
